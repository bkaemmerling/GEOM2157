...
'''symbol = QgsPolygonSymbol.createSimple({'color': 'red'})
TPZbuffer.renderer().setSymbol(symbol)
TPZbuffer.triggerRepaint()'''
...
myVectorLayer.rendererV2().symbols()[0].symbolLayer(0).properties()'''
